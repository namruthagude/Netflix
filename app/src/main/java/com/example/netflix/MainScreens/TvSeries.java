...
public class TvSeries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.homeicon:
                        Intent i = new Intent(TvSeries.this,MainScreen.class);
                        startActivity(i);
                        break;
                    case R.id.searchicon:
                        Intent j = new Intent(TvSeries.this,Search.class);
                        startActivity(j);
                        break;
                    case R.id.settingsicon:
                        Intent k = new Intent(TvSeries.this,Settings.class);
                        startActivity(k);
                        break;
    ...
    {
        mainRecycler = findViewById(R.id.TvSeriesRecylerView);
