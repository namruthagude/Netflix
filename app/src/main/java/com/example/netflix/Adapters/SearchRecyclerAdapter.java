...
public class SearchRecyclerAdapter extends RecyclerView.Adapter<SearchRecyclerAdapter.SearchViewHolder> implements Filterable {
    ...
    public SearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SearchViewHolder(LayoutInflater.from(context).inflate(R.layout.searchrecyclerlayout,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull SearchViewHolder holder, int position) {
        setItemRecycler(holder.searchRecycler,allCategoryList.get(position).getCategoryItemList());
    ...
    class SearchViewHolder extends RecyclerView.ViewHolder {
        ...
        public SearchViewHolder(@NonNull View itemView) {
            ...
            searchRecycler = itemView.findViewById(R.id.search_recyler);
        }
    }
